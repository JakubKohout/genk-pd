...
export function LawResetButton({ onReset }: Props) {
      ...
      >
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            ...
            data-testid="law-reset-confirm-yes"
          >
            Resetovat
          </button>
        </div>
